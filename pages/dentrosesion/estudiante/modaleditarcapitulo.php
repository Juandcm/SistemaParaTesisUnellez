...
<!--Inicio Modal titulos-->
<div class="modal fade" id="notafinal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">

  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel"><p class="text-dark">Nota del trabajo de grado</p></h4>
      </div>
      <div class="modal-body" id="vernotasusuario">
